...
(function($, window, document, undefined) {
    ...
    $.extend($.fn, {
        accrue: function(options) {
            ...
            options = $.extend({
                calculationMethod: calculateBasic
            }, $.fn.accrue.options, options);
    ...
    var calculateAmortization = function(elem, options, output_elem) {
        ...
        if (loan_info !== 0) {
            ...
            var output_content = '<table class="accrue-amortization">' +
                '<thead><tr>' +
                '<th class="accrue-payment-number">Payment Number</th>' +
                '<th class="accrue-payment-amount">Payment Amount</th>' +
            ...
            // Here is where I try to edit the API to output to my desired location

            $('#payment').html('$' + loan_info.payment_amount.toFixed(2));
            $('#totalPaid').html('$' + loan_info.total_payments.toFixed(2));
